...
<div class="eventsarea">
    <div id="opros"><h3>Здравствуйте!</h3>

        Предлагаем Вам принять участие в опросе о качестве условий оказания услуг учреждениями культуры.<br>
        Пожалуйста, ответьте на вопросы анкеты. Ваше мнение позволит улучшить работу организаций культуры и повысить качество оказания услуг населению.<br>

        Конфиденциальность высказанного Вами мнения о качестве условий оказания услуг учреждениями культуры гарантируется.<br><br>

        <a href="https://clck.ru/RautH" target="_blank">Принять участие</a>
    </div>
<?php
$query = qwe("
SELECT
