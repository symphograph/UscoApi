...
<div class="content">
    <div class="filesarea">
        ...
        <br>
        <details open="open">
            <summary>Учредительные документы</summary>
            <div class="docarea">
                <p><a href="documents/ustav_2018_09_17_with_egrul.pdf" class="flink">Устав учреждения от 17.09.2018</a>
                </p>
        ...
        <br>
        <details open="open">
            <summary>Муниципальное задание</summary>
            <div class="docarea">
                ...
                <p><a href="documents/report_MTask_2018.doc" class="flink">Отчеты по выполнению Муниципального задания
                        2018</a></p>
                <p><a href="documents/report_MTask_2019.pdf" class="flink">Отчеты по выполнению Муниципального задания
                        2019</a></p>
                <p><a href="documents/report_MTask_2020.pdf" class="flink">Отчеты по выполнению Муниципального задания
                        2020</a></p>
            </div>
        </details>
        <br>
        ...
        <br>
        <details open="open">
            <summary>Антикоррупционная деятельность</summary>
            <div class="docarea">
                <p>
                    <a href="documents/EventPlan.pdf" class="flink">
                        План мероприятий Муниципального бюджетного учреждения
                        «Южно-Сахалинский камерный оркестр» по противодействию коррупции на 2021-2022 годы
                    </a>
                </p>
                <br>
                <p>
                    <a href="documents/AboutConflictDiscords.pdf" class="flink">
                        Положение «О конфликте интересов в
                        Муниципальном бюджетном учреждении «Южно-Сахалинский камерный оркестр»
                    </a>
                </p>
                <br>
                <p>
                    <a href="documents/AboutUncorruptPolicy.pdf" class="flink">
                        Положение «Об антикоррупционной политике в
                        Муниципальном бюджетном учреждении «Южно-Сахалинский камерный оркестр»
                    </a>
                </p>
                <br>
                <p>
                    <a href="documents/BusinessGiftExchangeRules.pdf" class="flink">
                        Правила обмена деловыми подарками и
                        знаками делового гостеприимства в Муниципальном бюджетном учреждении «Южно-Сахалинский камерный
                        оркестр»
                    </a>
                </p>
                <br>
                <p>
                    <a href="documents/ProfessionalCodeOfEthics.pdf" class="flink">
                        Кодекс профессиональной этики и
                        служебного поведения работников Муниципального бюджетного учреждения «Южно-Сахалинский камерный
                        оркестр»
                    </a>
                </p>
                <br>
        ...
        <details open="open">
            <summary>Материально-техническая база</summary>
            <br>
            <div class="table">
                <div class="row">
                    <div class="col"><b>Наименование</b></div>
                    <div class="col"><b>Показатели по учреждению</b></div>
                </div>
                <div class="row">
                    <div class="col">Учреждение занимает отдельное здание, арендует (у кого), совместно с другими
                        организациями (какими)
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col">Здания оборудованы автоматической пожарной сигнализацией, системой оповещения и
                        управления людей
                    </div>
                </div>
                <div class="row">
                    <div class="col">Техническое состояние здания (удовлетворительное, требует кап. ремонта, аварийное,
                        требует текущего ремонта, подлежит сносу)
                    </div>
