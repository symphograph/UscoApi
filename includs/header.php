...
$host = 'https://'.$_SERVER['HTTP_HOST'].'/';
	?>
 <a href="<?php echo $host.'index.php';?>"><img src="<?php echo $host;?>img/logo.png"  width="80px" height="80px" alt="Логотип"/></a>
</div>
<nav class="bignav">
...
<div class="topline">
<div class="topin">
<div class="sitename"><a style="text-decoration: none; color: #e7ddcb" href="<?php echo $host;?>index.php">Южно-Сахалинский камерный оркестр</a></div>
<div class="conductor">Художественный руководитель
и главный дирижер<br>
